"""LocalImageAgent MCP Server entry point."""
...
# Configure Rich logging before any other imports that use the logger
...
def compress_image(
    ...
    return _tools.compress_image(
        _tools.CompressImageInput(
...
def compress_folder(
    ...
    return _tools.compress_folder(
        _tools.CompressFolderInput(
...
def resize_image(
    ...
    return _tools.resize_image(
        _tools.ResizeImageInput(
            input_file=input_file,
            output_file=output_file,
            width=width,
            height=height,
...
def batch_resize(
    ...
    return _tools.batch_resize(
        _tools.BatchResizeInput(
            input_folder=input_folder,
            output_folder=output_folder,
            width=width,
            height=height,
...
def convert_image(input_file: str, output_file: str) -> dict:
    ...
    return _tools.convert_image(
        _tools.ConvertImageInput(input_file=input_file, output_file=output_file)
    )
...
def batch_convert(
    ...
    return _tools.batch_convert(
        _tools.BatchConvertInput(
            input_folder=input_folder,
            output_folder=output_folder,
...
def strip_metadata(input_file: str, output_file: str) -> dict:
    ...
    return _tools.strip_metadata(
        _tools.StripMetadataInput(input_file=input_file, output_file=output_file)
    )
...
def create_thumbnail(
    ...
    return _tools.create_thumbnail(
        _tools.CreateThumbnailInput(
            input_file=input_file,
            output_file=output_file,
            width=width,
            height=height,
